...
class TestConversationStore:
    ...
    def test_search_messages_fts(self, conversation_store):
        ...
        results = conversation_store.search_messages(
            MessageSearchInput(
                conversation_id=conv.conversation_id,
                query="Python",
                mode="full_text",
...
class TestSummaryStore:
    ...
    def test_get_summary(self, summary_store, sample_conversation):
        conv, _ = sample_conversation
        created = summary_store.create_summary(
            CreateSummaryInput(
                conversation_id=conv.conversation_id,
                kind="leaf",
                depth=0,
    ...
    def test_summary_messages_link(self, summary_store, sample_conversation):
        ...
        s = summary_store.create_summary(
            CreateSummaryInput(
                conversation_id=conv.conversation_id,
                kind="leaf",
                depth=0,
    ...
    def test_dag_parent_child(self, summary_store, sample_conversation):
        conv, _ = sample_conversation
        child = summary_store.create_summary(
            CreateSummaryInput(
                conversation_id=conv.conversation_id,
                kind="leaf",
                depth=0,
        ...
        parent = summary_store.create_summary(
            CreateSummaryInput(
                conversation_id=conv.conversation_id,
                kind="condensed",
                depth=1,
    ...
    def test_dag_roots(self, summary_store, sample_conversation):
        conv, _ = sample_conversation
        s1 = summary_store.create_summary(
            CreateSummaryInput(
                conversation_id=conv.conversation_id,
                kind="leaf",
                depth=0,
        ...
        s2 = summary_store.create_summary(
            CreateSummaryInput(
                conversation_id=conv.conversation_id,
                kind="leaf",
                depth=0,
    ...
    def test_context_items(self, summary_store, sample_conversation):
        conv, msgs = sample_conversation
        summary_store.add_context_item(conv.conversation_id, 0, "message", message_id=msgs[0].message_id)
    ...
    def test_update_summary_metadata(self, summary_store, sample_conversation):
        ...
        summary_store.update_summary_metadata(s.summary_id, descendant_count=42, descendant_token_count=1000)
