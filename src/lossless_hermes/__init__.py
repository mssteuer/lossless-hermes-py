...
try:
    ...
    class ContextEngine:
        ...
        def compress(self, messages, current_tokens=None, **kwargs): return messages
        def on_session_start(self, session_id, **kwargs): pass
        def on_session_end(self, session_id, messages): pass
        ...
        def update_model(self, model, context_length, **kwargs): pass

# Import LCM components
from .db.config import resolve_lcm_config, LcmConfig
from .db.connection import initialize_database, close_database, get_database
from .db.migration import run_lcm_migrations
from .store.conversation import ConversationStore, MessageRecord, CreateMessageInput
from .store.summary import SummaryStore
from .compaction import CompactionEngine, CompactionConfig, CompactionResult
from .assembler import ContextAssembler, AssemblyConfig
...
class LcmContextEngine(ContextEngine):
    ...
    def __init__(
        ...
        **kwargs
        ...
        self.tools: Optional[LcmTools] = None
        ...
        **kwargs
        ...
        try:
            ...
            if should_compact:
                ...
                result = self.compaction_engine.compact(
                    conversation_id, current_tokens, cache_state
                )
                
                self.compression_count += 1
                
                logger.info(
                    f"LCM compaction complete: {result.summaries_created} summaries, "
